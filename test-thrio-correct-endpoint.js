...
// Test the CORRECT Thrio authentication endpoint
async function testThrioAuthentication() {
  console.log('🔐 Testing Thrio Authentication with External Validate Endpoint');
  console.log('===========================================================');
  
  const endpoint = 'https://nextivaapp.vercel.app/api/auth/external/validate';
...
// Run the test
testThrioAuthentication().catch(console.error);